...
import { g as getGqlNames } from './core-9f44263b.esm.js';
import { Q as QueryMode, f as fieldType, o as orderDirectionEnum } from './sqlite-ae6a913c.esm.js';
import _objectWithoutProperties from '@babel/runtime/helpers/esm/objectWithoutProperties';
import { g as graphqlBoundToKeystoneContext, J as JSON$1 } from './graphql-ts-schema-74a8c4fd.esm.js';
...
import { h as humanize, e as extensionError, a as accessReturnError, b as accessDeniedError, u as userInputError, v as validationFailureError, r as resolverError, c as relationshipError } from './graphql-errors-7d879e1a.esm.js';
...
import { m as mapUniqueWhereToWhere, r as resolveWhereInput, a as runWithPrisma, b as resolveUniqueWhereInput, i as isRejected, c as isFulfilled, g as getOperationAccess, d as getAccessFilters, e as checkFilterOrderAccess, f as getDBFieldKeyForFieldOnMultiField, p as promiseAllRejectWithAllErrors, h as findOne, j as findMany, k as count, l as getVariablesForGraphQLField, n as executeGraphQLFieldToRootVal, o as initialiseLists } from './types-for-lists-4d9c28b5.esm.js';
...
import { parseImageRef } from '../fields/types/image/utils/dist/keystone-next-keystone-fields-types-image-utils.esm.js';
import crypto from 'crypto';
import { pipeline } from 'stream';
import filenamify from 'filenamify';
import slugify from '@sindresorhus/slugify';
import { parseFileRef } from '../fields/types/file/utils/dist/keystone-next-keystone-fields-types-file-utils.esm.js';
import fetch from 'node-fetch';
import FormData from 'form-data';
import { isCuid } from 'cuid';
import { p as packagePath } from './package-path-edbecc32.esm.js';
...
const generateAdminUI = async (config, graphQLSchema, adminMeta, projectAdminPath, isLiveReload) => {
  ...
  const userPagesEntries = await fastGlob('**/*.{js,jsx,ts,tsx}', {
    cwd: userPagesDir
  });

  for (const filename of userPagesEntries) {
    const outputFilename = path__default.join('pages', filename);
    const path = path__default.relative(path__default.dirname(path__default.join(projectAdminPath, outputFilename)), path__default.join(userPagesDir, filename));
