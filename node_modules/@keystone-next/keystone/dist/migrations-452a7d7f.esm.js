...
import { c as confirmPrompt, E as ExitError, t as textPrompt } from './utils-1797fa58.esm.js';
...
async function pushPrismaSchemaToDatabase(dbUrl, schema, schemaPath) {
  let shouldDropDatabase = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  let before = Date.now();
