...
var fields_types_file_utils_dist_keystoneNextKeystoneFieldsTypesFileUtils = require('../../utils/dist/keystone-next-keystone-fields-types-file-utils.cjs.prod.js');
...
function validateRef(_ref) {
  ...
  if (!fields_types_file_utils_dist_keystoneNextKeystoneFieldsTypesFileUtils.parseFileRef(ref)) {
    return 'Invalid ref';
  }
}
