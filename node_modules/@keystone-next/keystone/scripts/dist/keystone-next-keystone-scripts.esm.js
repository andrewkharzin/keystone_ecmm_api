...
import { i as initConfig, s as serializePathForImport, c as createSystem, g as generateAdminUI, w as writeAdminFile } from '../../dist/initConfig-fe2fa91d.esm.js';
import { d as devMigrations, p as pushPrismaSchemaToDatabase } from '../../dist/migrations-452a7d7f.esm.js';
import { addHook } from 'pirates';
import * as babel from '@babel/core';
import sourceMapSupport from 'source-map-support';
import { d as defaults, c as createExpressServer, a as createAdminUIMiddleware } from '../../dist/createAdminUIMiddleware-6143b06c.esm.js';
import { p as printPrismaSchema, b as getSchemaPaths, c as getFormattedGraphQLSchema, d as generateNodeModulesArtifactsWithoutPrismaClient, e as generateCommittedArtifacts, a as generateNodeModulesArtifacts, r as requirePrismaClient, v as validateCommittedArtifacts } from '../../dist/artifacts-251c06e8.esm.js';
import { g as getConfigPath, a as getAdminPath, E as ExitError } from '../../dist/utils-1797fa58.esm.js';
import { o as initialiseLists } from '../../dist/types-for-lists-4d9c28b5.esm.js';
...
import '@hapi/iron';
import 'uid-safe';
import '../../dist/createApolloServer-bb8f01e4.esm.js';
...
`);
    ...
    const originalPrismaSchema = printPrismaSchema(initialiseLists(config.lists, config.db.provider), config.db.provider, config.db.prismaPreviewFeatures);
    ...
    while (true) {
      ...
      try {
        ...
        if (lastVersion !== version) {
          ...
          const newPrismaSchema = printPrismaSchema(initialiseLists(newConfig.lists, newConfig.db.provider), newConfig.db.provider, newConfig.db.prismaPreviewFeatures);
