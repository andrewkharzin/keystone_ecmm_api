...
var initConfig = require('../../dist/initConfig-5302ef8e.cjs.dev.js');
var migrations = require('../../dist/migrations-59709350.cjs.dev.js');
var pirates = require('pirates');
var babel = require('@babel/core');
var sourceMapSupport = require('source-map-support');
var createAdminUIMiddleware = require('../../dist/createAdminUIMiddleware-6ed8d856.cjs.dev.js');
var artifacts_dist_keystoneNextKeystoneArtifacts = require('../../dist/artifacts-9ff99aa4.cjs.dev.js');
var utils = require('../../dist/utils-22d9d904.cjs.dev.js');
var typesForLists = require('../../dist/types-for-lists-4a4a6e65.cjs.dev.js');
var _objectSpread = require('@babel/runtime/helpers/objectSpread2');
var execa = require('execa');
require('../../dist/core-11c9ffea.cjs.dev.js');
require('../../dist/sqlite-a2385a81.cjs.dev.js');
require('../../dist/graphql-ts-schema-2a220120.cjs.dev.js');
...
require('../../dist/graphql-errors-333c98d2.cjs.dev.js');
...
require('image-type');
require('image-size');
require('../../fields/types/image/utils/dist/keystone-next-keystone-fields-types-image-utils.cjs.dev.js');
require('crypto');
require('stream');
require('filenamify');
require('@sindresorhus/slugify');
require('../../fields/types/file/utils/dist/keystone-next-keystone-fields-types-file-utils.cjs.dev.js');
require('node-fetch');
require('form-data');
require('cuid');
require('../../dist/package-path-f000d409.cjs.dev.js');
require('@prisma/sdk');
require('@prisma/migrate');
require('cors');
require('graphql-upload');
require('../../session/dist/keystone-next-keystone-session.cjs.dev.js');
require('cookie');
require('@hapi/iron');
require('uid-safe');
require('../../dist/createApolloServer-bea6aca3.cjs.dev.js');
...
`);
    ...
    const originalPrismaSchema = artifacts_dist_keystoneNextKeystoneArtifacts.printPrismaSchema(typesForLists.initialiseLists(config.lists, config.db.provider), config.db.provider, config.db.prismaPreviewFeatures);
    ...
    while (true) {
      ...
      try {
        ...
        if (lastVersion !== version) {
          ...
          const newPrismaSchema = artifacts_dist_keystoneNextKeystoneArtifacts.printPrismaSchema(typesForLists.initialiseLists(newConfig.lists, newConfig.db.provider), newConfig.db.provider, newConfig.db.prismaPreviewFeatures);
          ...
          if (newPrintedGraphQLSchema !== lastPrintedGraphQLSchema) {
            await fs__namespace["default"].writeFile(artifacts_dist_keystoneNextKeystoneArtifacts.getSchemaPaths(cwd).graphql, artifacts_dist_keystoneNextKeystoneArtifacts.getFormattedGraphQLSchema(newPrintedGraphQLSchema));
            lastPrintedGraphQLSchema = newPrintedGraphQLSchema;
          }

          await artifacts_dist_keystoneNextKeystoneArtifacts.generateNodeModulesArtifactsWithoutPrismaClient(graphQLSchema, newConfig, cwd);
...
async function setupInitialKeystone(config, cwd, shouldDropDatabase) {
  ...
  const prismaSchema = (await artifacts_dist_keystoneNextKeystoneArtifacts.generateCommittedArtifacts(graphQLSchema, config, cwd)).prisma;
  let keystonePromise = artifacts_dist_keystoneNextKeystoneArtifacts.generateNodeModulesArtifacts(graphQLSchema, config, cwd).then(() => {
    const prismaClient = artifacts_dist_keystoneNextKeystoneArtifacts.requirePrismaClient(cwd);
    return getKeystone(prismaClient);
  });
  let migrationPromise; // Set up the Database

  if (config.db.useMigrations) {
    migrationPromise = migrations.devMigrations(config.db.url, prismaSchema, artifacts_dist_keystoneNextKeystoneArtifacts.getSchemaPaths(cwd).prisma, shouldDropDatabase);
  } else {
    migrationPromise = migrations.pushPrismaSchemaToDatabase(config.db.url, prismaSchema, artifacts_dist_keystoneNextKeystoneArtifacts.getSchemaPaths(cwd).prisma, shouldDropDatabase);
  }
...
async function build(cwd) {
  ...
  await artifacts_dist_keystoneNextKeystoneArtifacts.validateCommittedArtifacts(graphQLSchema, config, cwd);
  ...
  await artifacts_dist_keystoneNextKeystoneArtifacts.generateNodeModulesArtifacts(graphQLSchema, config, cwd);
...
async function postinstall(cwd, shouldFix) {
  ...
  if (shouldFix) {
    await artifacts_dist_keystoneNextKeystoneArtifacts.generateCommittedArtifacts(graphQLSchema, config, cwd);
