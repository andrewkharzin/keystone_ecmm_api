...
var context = require('@keystone-next/keystone/admin-ui/context');
var isDeepEqual = require('fast-deep-equal');
var apollo = require('@keystone-next/keystone/admin-ui/apollo');
var router = require('@keystone-next/keystone/admin-ui/router');
var components = require('@keystone-next/keystone/admin-ui/components');
var utils = require('@keystone-next/keystone/admin-ui/utils');
var _extends = require('@babel/runtime/helpers/extends');
var _objectWithoutProperties = require('@babel/runtime/helpers/objectWithoutProperties');
var SigninContainer = require('../../../dist/SigninContainer-af6a2722.cjs.prod.js');
...
const Welcome = ({
  ...
  const onSubmit = event => {
    ...
    return router$1.push(router$1.query.from || '/');
  };
...
const InitPage = ({
  ...
  }, [rawKeystone.authenticatedItem, enableWelcome, router$1]);
  return mode === 'init' ? core.jsx(SigninContainer.SigninContainer, null, core.jsx(core.H1, null, "Welcome to KeystoneJS"), core.jsx("p", null, "Create your first user to get started"), core.jsx("form", {
    onSubmit: event => {
    ...
    weight: "bold",
    tone: "active"
  }, "Get started")))) : core.jsx(SigninContainer.SigninContainer, null, core.jsx(Welcome, {
    value: value
  }));
};
