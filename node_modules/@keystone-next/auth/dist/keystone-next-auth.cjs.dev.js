...
var url = require('url');
var fields = require('@keystone-next/keystone/fields');
...
function getBaseAuthSchema({
  ...
  const ItemAuthenticationWithPasswordSuccess = keystone.graphql.object()({
    name: gqlNames.ItemAuthenticationWithPasswordSuccess,
    fields: {
      sessionToken: keystone.graphql.field({
        type: keystone.graphql.nonNull(keystone.graphql.String)
      }),
      item: keystone.graphql.field({
        type: keystone.graphql.nonNull(base.object(listKey))
      })
    }
  });
  const ItemAuthenticationWithPasswordFailure = keystone.graphql.object()({
    name: gqlNames.ItemAuthenticationWithPasswordFailure,
    fields: {
      message: keystone.graphql.field({
        type: keystone.graphql.nonNull(keystone.graphql.String)
      })
    }
  });
  const AuthenticationResult = keystone.graphql.union({
  ...
  const extension = {
    ...
    mutation: {
      [gqlNames.authenticateItemWithPassword]: keystone.graphql.field({
        type: AuthenticationResult,
        args: {
          [identityField]: keystone.graphql.arg({
            type: keystone.graphql.nonNull(keystone.graphql.String)
          }),
          [secretField]: keystone.graphql.arg({
            type: keystone.graphql.nonNull(keystone.graphql.String)
          })
        },
...
function getInitFirstItemSchema({
  ...
  const initialCreateInput = keystone.graphql.wrap.inputObject(new graphql.GraphQLInputObjectType(_objectSpread(_objectSpread({}, createInputConfig), {}, {
  ...
  return {
    mutation: {
      [gqlNames.createInitialItem]: keystone.graphql.field({
        type: keystone.graphql.nonNull(ItemAuthenticationWithPasswordSuccess),
        args: {
          data: keystone.graphql.arg({
            type: keystone.graphql.nonNull(initialCreateInput)
          })
        },
...
const PasswordResetRedemptionErrorCode = keystone.graphql.enum({
  name: 'PasswordResetRedemptionErrorCode',
  values: keystone.graphql.enumValues(errorCodes$1)
});
function getPasswordResetSchema({
  ...
  const getResult = name => keystone.graphql.object()({
    name,
    fields: {
      code: keystone.graphql.field({
        type: keystone.graphql.nonNull(PasswordResetRedemptionErrorCode)
      }),
      message: keystone.graphql.field({
        type: keystone.graphql.nonNull(keystone.graphql.String)
      })
  ...
  return {
    mutation: {
      [gqlNames.sendItemPasswordResetLink]: keystone.graphql.field({
        type: keystone.graphql.nonNull(keystone.graphql.Boolean),
        args: {
          [identityField]: keystone.graphql.arg({
            type: keystone.graphql.nonNull(keystone.graphql.String)
          })
      ...
      [gqlNames.redeemItemPasswordResetToken]: keystone.graphql.field({
        type: RedeemItemPasswordResetTokenResult,
        args: {
          [identityField]: keystone.graphql.arg({
            type: keystone.graphql.nonNull(keystone.graphql.String)
          }),
          token: keystone.graphql.arg({
            type: keystone.graphql.nonNull(keystone.graphql.String)
          }),
          [secretField]: keystone.graphql.arg({
            type: keystone.graphql.nonNull(keystone.graphql.String)
    ...
    query: {
      [gqlNames.validateItemPasswordResetToken]: keystone.graphql.field({
...
const MagicLinkRedemptionErrorCode = keystone.graphql.enum({
  name: 'MagicLinkRedemptionErrorCode',
  values: keystone.graphql.enumValues(errorCodes)
});
function getMagicAuthLinkSchema({
  ...
  const RedeemItemMagicAuthTokenFailure = keystone.graphql.object()({
    name: gqlNames.RedeemItemMagicAuthTokenFailure,
    fields: {
      code: keystone.graphql.field({
        type: keystone.graphql.nonNull(MagicLinkRedemptionErrorCode)
      }),
      message: keystone.graphql.field({
        type: keystone.graphql.nonNull(keystone.graphql.String)
      })
  ...
  const RedeemItemMagicAuthTokenSuccess = keystone.graphql.object()({
    name: gqlNames.RedeemItemMagicAuthTokenSuccess,
    fields: {
      token: keystone.graphql.field({
        type: keystone.graphql.nonNull(keystone.graphql.String)
      }),
      item: keystone.graphql.field({
        type: keystone.graphql.nonNull(base.object(listKey))
  ...
  const RedeemItemMagicAuthTokenResult = keystone.graphql.union({
  ...
  return {
    mutation: {
      [gqlNames.sendItemMagicAuthLink]: keystone.graphql.field({
        type: keystone.graphql.nonNull(keystone.graphql.Boolean),
        args: {
          [identityField]: keystone.graphql.arg({
            type: keystone.graphql.nonNull(keystone.graphql.String)
      ...
      [gqlNames.redeemItemMagicAuthToken]: keystone.graphql.field({
        type: keystone.graphql.nonNull(RedeemItemMagicAuthTokenResult),
        args: {
          [identityField]: keystone.graphql.arg({
            type: keystone.graphql.nonNull(keystone.graphql.String)
          }),
